...
var app = (function () {
    ...
    const file$5 = "src/components/mobile_modal.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 8, 4, 102);
    ...
    class Mobile_modal extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { dismiss: 0 });
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 88, 3, 1514);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-klws3g");
    			add_location(a, file$4, 83, 5, 1120);
    			attr_dev(h20, "class", "nav-button svelte-klws3g");
    			add_location(h20, file$4, 82, 4, 1091);
    			attr_dev(h21, "class", "nav-button svelte-klws3g");
    			add_location(h21, file$4, 85, 4, 1438);
    			attr_dev(div, "class", "buttons-wrapper svelte-klws3g");
    			add_location(div, file$4, 81, 3, 1057);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 75, 3, 985);
    			add_location(div0, file$4, 74, 2, 976);
    			attr_dev(div1, "class", "header-inner svelte-klws3g");
    			add_location(div1, file$4, 73, 1, 947);
    			attr_dev(header, "class", "header svelte-klws3g");
    			add_location(header, file$4, 72, 0, 922);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/components/main_panel_1.svelte";
    ...
    const file$2 = "src/components/two_col_panel.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 6, 4, 164);
    			attr_dev(div1, "class", "column svelte-14tg5js");
    			add_location(div1, file$2, 10, 4, 235);
    			attr_dev(section, "class", "svelte-14tg5js");
    			add_location(section, file$2, 5, 0, 150);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1 = "src/components/main_panel_2.svelte";
    ...
    function create_col2_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-qwf0t");
    			add_location(h2, file$1, 31, 16, 1404);
    			if (!src_url_equal(img.src, img_src_value = "")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "route-image svelte-qwf0t");
    			add_location(img, file$1, 32, 16, 1461);
    			attr_dev(li0, "class", "svelte-qwf0t");
    			add_location(li0, file$1, 34, 20, 1542);
    			attr_dev(li1, "class", "svelte-qwf0t");
    			add_location(li1, file$1, 35, 20, 1589);
    			attr_dev(li2, "class", "svelte-qwf0t");
    			add_location(li2, file$1, 36, 20, 1636);
    			attr_dev(ul, "class", "svelte-qwf0t");
    			add_location(ul, file$1, 33, 16, 1517);
    			attr_dev(div, "class", "column-inner svelte-qwf0t");
    			attr_dev(div, "slot", "col2");
    			add_location(div, file$1, 30, 12, 1349);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 10, 12, 321);
    			attr_dev(li0, "class", "svelte-qwf0t");
    			add_location(li0, file$1, 12, 20, 448);
    			attr_dev(li1, "class", "svelte-qwf0t");
    			add_location(li1, file$1, 13, 20, 632);
    			attr_dev(li2, "class", "svelte-qwf0t");
    			add_location(li2, file$1, 14, 20, 794);
    			attr_dev(li3, "class", "svelte-qwf0t");
    			add_location(li3, file$1, 15, 20, 863);
    			attr_dev(ul, "class", "svelte-qwf0t");
    			add_location(ul, file$1, 11, 16, 423);
    			attr_dev(div, "class", "text-block svelte-qwf0t");
    			add_location(div, file$1, 9, 8, 284);
    			attr_dev(section, "class", "svelte-qwf0t");
    			add_location(section, file$1, 8, 0, 266);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file = "src/components/main_panel_3.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-12pq49p");
    			add_location(h1, file, 5, 4, 87);
    			add_location(h2, file, 9, 12, 195);
    			add_location(li, file, 11, 16, 256);
    			add_location(ul, file, 10, 12, 235);
    			attr_dev(div0, "class", "info-box-inner");
    			add_location(div0, file, 8, 8, 154);
    			attr_dev(div1, "class", "info-box");
    			add_location(div1, file, 7, 4, 123);
    			attr_dev(section, "class", "svelte-12pq49p");
    			add_location(section, file, 4, 0, 73);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Panel1: Main_panel_1, Panel2: Main_panel_2, Panel3: Main_panel_3 });
    	return [];
    }
