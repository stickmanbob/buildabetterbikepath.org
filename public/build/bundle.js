    ...
    function create_col1_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file$2, 27, 20, 2072);
    			attr_dev(li1, "class", "svelte-3e4gdo");
    			add_location(li1, file$2, 28, 20, 2170);
    			attr_dev(li2, "class", "svelte-3e4gdo");
    			add_location(li2, file$2, 29, 20, 2273);
    			attr_dev(ul, "class", "svelte-3e4gdo");
    			add_location(ul, file$2, 26, 16, 2047);
    ...
    function create_col2_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-3e4gdo");
    			add_location(h2, file$2, 34, 16, 2471);
    			...
    			attr_dev(img, "class", "route-image svelte-3e4gdo");
    			add_location(img, file$2, 35, 16, 2528);
    			attr_dev(li0, "class", "svelte-3e4gdo");
    			add_location(li0, file$2, 37, 20, 2684);
    			attr_dev(li1, "class", "svelte-3e4gdo");
    			add_location(li1, file$2, 38, 20, 2764);
    			attr_dev(li2, "class", "svelte-3e4gdo");
    			add_location(li2, file$2, 39, 20, 2864);
    			attr_dev(li3, "class", "svelte-3e4gdo");
    			add_location(li3, file$2, 40, 20, 2970);
    			attr_dev(li4, "class", "svelte-3e4gdo");
    			add_location(li4, file$2, 41, 20, 3096);
    			attr_dev(ul, "class", "svelte-3e4gdo");
    			add_location(ul, file$2, 36, 16, 2659);
    			attr_dev(div, "class", "column-inner svelte-3e4gdo");
    			attr_dev(div, "slot", "col2");
    			add_location(div, file$2, 33, 12, 2416);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			li3 = element("li");
    			li3.textContent = "The current design has a steep (5%) slope and empties into the Rincon Beach parking lot. This will likely lead to many accidents as bikers colide with cars at high speed.";
    			t9 = space();
    			li4 = element("li");
